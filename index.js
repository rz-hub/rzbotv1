...
//
const BotName = 'RZBOTV1 👹'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/rz_sbn'; // Nama Instagramlu cok
const whatsapplu = '085231865675'; // Nomor whatsapplu cok
